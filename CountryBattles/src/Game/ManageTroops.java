...
public class ManageTroops {
    ...
    public void CreateTroops() {
        ...
        int numTroops1 = troopCount.get(index1)/100;
        int numTroops2 = troopCount.get(index2)/100;
        ...
        for (int i = 0; i < troops1.length; i++) {
            ...
            troops1[i].setTarget(chooseTarget(troops1, troops1AliveIdx));
        }
        ...
        for (int i = 0; i < troops2.length; i++) {
            ...
            troops2[i].setTarget(chooseTarget(troops2, troops2AliveIdx));
    ...
    public void updateTroops(Graphics g) {
        ...
        for (Troop troop : troops1) {
            if (troop.getTarget() == null || !troop.getTarget().isAlive()) {
